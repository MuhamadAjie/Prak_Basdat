            ...
            <section id="hello" class="home bg-mega">
                ...
                <div class="container">
                    <div class="row">
                        <div class="main_home">
                            <div class="home_text">
                                <h1 class="text-white">WE’RE <br /> WORLD CHANGE!</h1>
                            </div>
                        ...
                        <div class="main_about">
                            <div class="col-md-6">
                                <div class="about_content">
                                    ...
                                    <p>Kami dari kelompok 2 praktikum sistem basis data, yang beranggotakan 3 orang yaitu muhamad ajie darmawan, agung afrizal dan mz fajar</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="about_accordion wow fadeIn">
                                    <div id="faq_main_content" class="faq_main_content">
                                        ...
                                        <div>
                                            <div class="content">
                                                <p>Sederhana namun unik itulah motto kami dalam mengembangkan
                                                    website ini, agar anda semakin nyaman dalam menggunakan 
                                                    layanan kami. </p>
                                        ...
                                        <div class="open">
                                            <div class="content">
                                                <p>Bekerja dengan tim terbaik jadi anda tidak perlu khawatir,
                                                    karena tim kami berasal dari orang-orang pilihan.</p>
                                            </div>
                                        ...
                                        <div>
                                            <div class="content">
                                                <p>Tidak perlu khawatir jika terjadi masalah tim kami,
                                                    selalu siap setiap saat dan saat anda butuhkan kontak kami.</p>
                                            </div>
                                        ...
                                        <div>
                                            <div class="content">
                                                <p>Tentu kami akan memberikan update kepada anda,
                                                    secara gratis dan menyenangkan.</p>
                                            </div>
                        ...
                        <div class="about_bottom_content">
                            <div class="col-md-4">
                                <div class="about_bottom_item m-top-20">
                                    ...
                                    <p class="m-top-20">Menjadi pelopor kreative pada bidang eksport dan import yang melayani berbagai tujuan dunia. </p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="about_bottom_item m-top-20">
                                    ...
                                    <p class="m-top-20">Kami juga sangat bersahabat dengan anda memberikan kemudahan dalam bertransaksi, dan apa yang anda ingin eksport atau import. </p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="about_bottom_item m-top-20">
                                    ...
                                    <p class="m-top-20">Tentu kesederhanaan menjadi prioritas agar anda mudah memahami dalam penggunaan web kami. </p>
                                </div>
                            </div>
                        </div>
                    </div><!--End off row-->
            ...
            <section id="video" class="video">
                ...
                <div class="main_video roomy-100 m-top-100 m-bottom-100 text-center">
                    <div class="video_text text-center">
                        <a href="https://www.youtube.com/watch?v=4U9FgYP-GQs" class="video-link"><span class="fa fa-play"></span></a>
                    </div>
                </div>
                        ...
                        <div class="main_portfolio roomy-100">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="head_title text-center">
                                    ...
                                    <p>Portofolio kami sebagai peyakin anda dengan layanan yang kami sediakan, 
                                        kemudahan, kenyamanan, akan anda dapatkan segera setelah anda 
                                        mengunjungi website kami. </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="rage_widget">
                                    <div class="widget_head">
                                        <h3 class="text-white">IMPex</h3>
                                        <div class="separator_small"></div>
                                    </div>
                                    <p>Layanan web import eksport berkualitas tanpa batas, memudahkan
                                        anda dalam melakukan transaksi perdagangan dimanapun dan kapanpun,
                                        kepuasan anda adalah prioritsas kami.</p>
                    ...
                    <div class="row">
                        <div class="main_footer text-center p-top-40 p-bottom-30">
                            <p class="wow fadeInRight" data-wow-duration="1s">
                                ...
                                by 
                                <a target="_blank" href="http://bootstrapthemes.co">Group Two</a> 
                                2018. Praktikum Sistem Basis Data
                            </p>
                        </div>
                    </div>
                </div>
