        ...
        <html lang="en">
          <head>
            ...
            <!--Icon Fonts-->
            <link rel="stylesheet" media="screen" href="assetss/fonts/font-awesome/font-awesome.min.css" />
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="pricing-table">
                                <div class="pricing-header">
                                    <p class="pricing-title">Barang Lokal</p>
                                    <p class="pricing-rate"><sup>$</sup> 0 <span>/Mo.</span></p>
                                    <a href="home" class="btn btn-custom">And Get Free Month</a>
                                </div>
